...
$(document).ready(function() {
    ...
    //enables p1 to choose player, moves chosen player to specified area, then run function for enemy select
    ...
    //enemy selection function, enables startBattle function to run after it changes gameStart to true
    ...
    //start battle function, enables attack button to run attack function
    //also checks opponent health to see whether to run checkProgress function or counterAtack
